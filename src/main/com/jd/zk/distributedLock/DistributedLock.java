    ...
    public  boolean checkMinPath() throws KeeperException, InterruptedException {
        ...
        switch (index) {
            case -1: {
            	...
            	System.out.println(LOG_PREFIX_OF_THREAD + " 本节点不在了..." + selfPath);
                return false;
            }
            case 0: {
                /* 线程获取分布式锁成功 */
            	System.out.println(LOG_PREFIX_OF_THREAD + " 子节点中，果然我最大" + selfPath);
                return true;
            }
            default: {
                ...
                System.out.println(LOG_PREFIX_OF_THREAD + " 获取子节点中: "+ selfPath +" ，排在我前面的" + waitPath);
                ...
                try {
                    ...
                    if (zk.exists(waitPath, false) == null) {
                    	System.out.println(LOG_PREFIX_OF_THREAD+" 子节点中: "+ selfPath +" ，排在我前面的"+waitPath+"已失踪，幸福来得太突然?");
                        return checkMinPath();
                    } else {
                        throw e;
                    }
    ...
    public boolean createPath (String path, String data) {
        try {
            if (zk.exists(path, false) == null) {
                ...
                System.out.println(LOG_PREFIX_OF_THREAD + " 节点创建成功， Path:" + result + ", content" + data);
            }
        } catch (KeeperException e) {
            //e.printStackTrace();
        	
        	System.out.println("创建"+path+"失败："+e.getMessage());
